...
public class Map <K, V>{
    ...
    /**
     * Adds a new entry to the map using the provided key and value
     * the value previously associated with the key, if the key was not in the map prior, returns null
     * @param key
     * @param value
     * @return
     */
    ...
    //create a new array of increased size, move old values over
    //adding
    ...
    //when removing keys from the map

...
/*
    Abstract classes
        ...
        - Still have constructors, because subclasses will leverage these for their own instantiation.

        - Can have zero or more abstract methods contained within its declaration.
            + abstract methods are simply methods that do not have any implementation, also called "method stubs";

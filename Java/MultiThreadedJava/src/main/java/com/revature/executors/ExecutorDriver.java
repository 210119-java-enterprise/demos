...
public class ExecutorDriver {
    ...
    public static void main(String[] args) {
        ...
        /*
            Executor Pattern
                ...
                - aims to improve the use of thread resources
                    ...
                    + threads remain in the pool even after the Runnable/Callable logic is complete
        ...
        Runnable task_1 = () -> System.out.println("task 1 is running in "+ Thread.currentThread().getName());
        Runnable task_2 = () -> System.out.println("task 2 is running in "+Thread.currentThread().getName());
        ...
        // this is necessary, otherwise the JVM continues to run indefinetely because it will not terminate until all
